...
export default function SyncSection() {
  return (
    <section id="sync" className="bg-zinc-950 py-20 text-white sm:py-28">
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_0.9fr]">
          <div>
            ...
            <h2 className="mt-4 max-w-4xl text-4xl font-semibold tracking-normal sm:text-6xl">
              A regra de negócio agora é clara: local cria, nuvem confirma,
              versão protege.
            </h2>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-zinc-300">
              Quando a conexão oscila, o documento mantém uma identidade local.
              Quando a nuvem responde, o editor passa a salvar por ID e versão,
              sem recriar cópias em reloads ou retries.
            </p>
          </div>
